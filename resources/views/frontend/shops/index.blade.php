<x-app-layout>
    ...
    <section>
        <div class="relative">
            ...
            <div class="absolute inset-0 py-8">
                <div class="max-w-[80%] mx-auto w-full h-full">
                    <nav aria-label="Breadcrumb">
                        <ol role="list" class="flex items-center space-x-4">
                            <li>
                                <div class="flex items-center">
                                    <a href="/" class="mr-4 text-sm font-bold text-theme-gray uppercase">Home</a>
                            ...
                            <li>
                                <div class="flex items-center">
                                    <a href="" class="mr-4 text-sm font-bold text-theme-gray uppercase">{{ $shop_section }}</a>
                                    <svg viewBox="0 0 6 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" class="h-5 w-auto text-theme-gray">
                                        <path d="M4.878 4.34H3.551L.27 16.532h1.327l3.281-12.19z" fill="currentColor" />
                                    </svg>
                                </div>
                            ...
                            <li class="text-sm">
                                <a href="" aria-current="page" class="text-sm font-bold text-theme-gray uppercase pointer-events-none">{{ $data_section->name }}</a>
                            </li>
                        </ol>
                    </nav>
