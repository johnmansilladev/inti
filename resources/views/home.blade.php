<x-app-layout>
    ...
    <section>
        <div class="max-w-[80%] mx-auto my-10">
            <div class="max-w-4xl mx-auto">
                ...
                <p class="text-lg text-theme-gray text-center mt-4">Contamos con una amplia cobertura en software de diagnostico y catálogo de partes.</p>
            </div>
        </div>
    </section>
    ...
    @if ($categories->count())
    <section>
        <div class="max-w-[60%] mx-auto py-20">
    ...
    <section class="bg-theme-swhite">
        <div class="max-w-[80%] mx-auto py-20">
            <h1 class="text-4xl font-extrabold text-theme-gray text-center uppercase">LO MÁS VENDIDO EN PERÚ</h1>
