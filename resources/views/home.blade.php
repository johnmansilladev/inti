<x-app-layout>
                            ...
                            <a href="{{ $slider->redirect_to }}" class="{{ $slider->is_redirect == 0 ? 'pointer-events-none' : '' }}" target="{{ $slider->new_tab == 1 ? '_blank' : '_self' }}">
                                <div class="relative">
                                    ...
                                    <div class="absolute inset-0 h-full">
                                        <div class="max-w-[80%] mx-auto grid grid-cols-2 h-full">
    ...
    <section style="background: linear-gradient(180deg, #FDC900 0%, #FDA200 100%);">
        <div class="py-20">
            ...
            <div x-data="{swiper: null}" x-init="swiper = new Swiper($refs.container, {
                ...
                <div class="swiper max-w-[80%] mx-auto pt-10 pb-20 px-1" x-ref="container">
                    <ul class="swiper-wrapper">
    ...
    @if ($categories->count())
    <section>
        <div class="max-w-[70%] mx-auto py-20">
    ...
    <section class="bg-theme-swhite">
        <div class="max-w-[80%] mx-auto py-20">
            ...
            <p class="max-w-4xl mx-auto text-lg text-center text-theme-gray mt-4 mb-10">Se requieren algunos activos para instalar, utilizar y actualizar software, ofrecemos servicio y soporte técnico para todos los programas.⁣⁣⁣</p>
            <ul role="list" class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 lg:gap-8">
    ...
    <section class="bg-theme-lwgray">
        <div class="max-w-[80%] mx-auto text-center pt-20 pb-12">
