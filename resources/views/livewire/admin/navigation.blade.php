<div class="flex min-h-full">
    <!-- Narrow sidebar -->
<div class="hidden w-28 overflow-y-auto bg-theme-black md:block">
    <div class="flex w-full flex-col items-center py-2">
        <a href="{{ route('admin.home') }}" class="flex flex-shrink-0 items-center">
            <img class="h-10 w-auto" src="{{ Storage::url('images/logo-inti-lite-2.png') }}" title="inti Diesel" alt="Inti Diesel">
        </a>
        <div class="mt-6 w-full flex-1 space-y-1 px-2">
            <!-- Current: "bg-indigo-800 text-white", Default: "text-indigo-100 hover:bg-indigo-800 hover:text-white" -->
            <a href="{{ route('admin.home') }}"
                class="text-white hover:bg-theme-yellow hover:text-black group w-full p-3 rounded-md flex flex-col items-center text-xs font-medium">
                <svg class="text-white group-hover:text-black h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none"
          ...
          <svg class="text-indigo-300 group-hover:text-white h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
      ...
      -->
        ...
        -->
            ...
            <div class="mt-5 h-0 flex-1 overflow-y-auto px-2">
                ...
                <svg class="text-indigo-300 group-hover:text-white mr-3 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
