              ...
              <section aria-labelledby="detail-items">
                <div class="bg-white shadow sm:rounded-lg">
                  ...
                  <div class="border-t border-gray-200 px-4 py-2 sm:px-6">
                    ...
                    <div class="row items-center hover:bg-gray-100 group py-2 md:py-4  {{ !$loop->last ? 'border-b' : '' }}">
       ...
       --}}
                    {{-- <li>
                      <div class="relative pb-8">
                        ...
                        <div class="relative flex space-x-3">
                          <div>
                            <span class="h-8 w-8 rounded-full bg-theme-lgray flex items-center justify-center ring-8 ring-white">
                              <svg class="h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                <path fill-rule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8 10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 011.05-.143z" clip-rule="evenodd" />
                              </svg>
                            </span>
                          ...
                          <div class="flex min-w-0 flex-1 justify-between space-x-4 pt-1.5">
                            <div>
                              <p class="text-sm text-gray-500">Advanced to phone screening by</p>
                            </div>
                            <div class="whitespace-nowrap text-right text-sm text-gray-500">
                    ...
                    {{-- <li>
                      <div class="relative pb-8">
                        ...
                        <div class="relative flex space-x-3">
                          ...
                          <div class="flex min-w-0 flex-1 justify-between space-x-4 pt-1.5">
                            <div>
                              <p class="text-sm text-gray-500">Completed phone screening with</p>
                            </div>
                            <div class="whitespace-nowrap text-right text-sm text-gray-500">
                    ...
                    {{-- <li>
                      <div class="relative pb-8">
                        ...
                        <div class="relative flex space-x-3">
                          ...
                          <div class="flex min-w-0 flex-1 justify-between space-x-4 pt-1.5">
                            <div>
                              <p class="text-sm text-gray-500">Advanced to interview by</p>
                            </div>
                            <div class="whitespace-nowrap text-right text-sm text-gray-500">
                    ...
                    <li>
                      <div class="relative pb-8">
                        <div class="relative flex space-x-3">
                          ...
                          <div class="flex min-w-0 flex-1 justify-between space-x-4 pt-1.5">
                            <div>
                              <p class="text-sm text-gray-500">{{ __('Pendiente') }}</p>
                            </div>
                            <div class="whitespace-nowrap text-right text-sm text-gray-500">
