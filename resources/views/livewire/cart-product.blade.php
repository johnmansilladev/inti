            ...
            <div class="pointer-events-none fixed inset-y-0 right-0 flex max-w-[420px] pl-10">
                ...
                <div x-show="shoppingCartOpen"
                    ...
                    <div class="flex h-full flex-col  bg-white shadow-xl">
                                            ...
                                            <div class="mt-2">
                                                <div class="flex justify-between text-base font-medium text-gray-900">
                                                    ...
                                                    <p class="text-xs ml-4">
                                                        ...
                                                        99.90
                                                        <span
                                                            class="bg-red-600 text-white font-medium px-2 py-[2px] text-[10px] rounded pl-2">-
                                                            20%</span>
                                                    </p>
                                                </div>
                                            </div>

                                            <div class="flex flex-1 items-end justify-between font-medium text-xs mt-4">
                        ...
                        @else
                            <div class="px-6 py-3 h-full flex">
                        ...
                        <div class="flex flex-col mt-auto mx-6 py-4 border-t-2 border-theme-orange">
                            <div class="flex justify-between font-semibold capitalize pb-4">
                                <p>total:</p>
                                <p>USD {{ Cart::getTotal() }}</p>
                            </div>
                            <button type="button" @click="shoppingCartOpen = false; disabledPage()"
                                class="flex items-center justify-center py-2 px-8 border border-transparent text-sm font-semibold mb-3 rounded-md text-theme-black uppercase bg-theme-lgray">Seguir
                                navegando</button>
                            <button type="button"
                                class="flex items-center justify-center py-2 px-8 border border-transparent text-sm font-semibold rounded-md text-white uppercase bg-theme-gray">Ir
                                a comprar</button>
                        </div>
                    </div>
                </div>
