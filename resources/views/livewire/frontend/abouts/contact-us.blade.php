                    ...
                    <div class="grid grid-cols-12 gap-3 lg:gap-6">
                        ...
                        <div class="col-span-12">
                            <div class="flex">
                                ...
                                <label for="contact-politics" class="font-medium text-gray-700">Acepto la <a href="" class="font-bold hover:underline">política de privacidad de datos</a>.</label>
                                </div>
                            </div>
        ...
        <div class="max-w-[90%] lg:max-w-[60%] mx-auto py-5 lg:py-10 border-t-2 border-theme-gray">
            <div class="row">
                ...
                <ul role="list" class="w-full lg:w-3/5 lg:pl-6 grid grid-cols-5 gap-2 lg:gap-12">
                    <li>
                        <a href="https://api.whatsapp.com/send?phone=51930825355" class="flex flex-col items-center lg:bg-theme-gray rounded-lg transition duration-500 lg:hover:scale-105 p-4 lg:hover:bg-gradient-to-r lg:hover:from-theme-yellow lg:hover:to-theme-orange"  target="_blank" rel="noopener noreferrer">
                            <div class="bg-theme-yellow lg:bg-theme-gray p-3 lg:p-0 rounded-full lg:rounded-none">
                    ...
                    <li>
                        <a href="https://www.facebook.com/IntiDieselpe" class="flex flex-col items-center lg:bg-theme-gray rounded-lg transition duration-500 lg:hover:scale-105 p-4 lg:hover:bg-gradient-to-r lg:hover:from-theme-yellow lg:hover:to-theme-orange"  target="_blank" rel="noopener noreferrer">
                            <div class="bg-theme-yellow lg:bg-theme-gray p-3 lg:p-0 rounded-full lg:rounded-none">
                                <svg class="h-6 w-6" viewBox="0 0 37 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li>
                        <a href="#" class="flex flex-col items-center lg:bg-theme-gray rounded-lg transition duration-500 lg:hover:scale-105 p-4 lg:hover:bg-gradient-to-r lg:hover:from-theme-yellow lg:hover:to-theme-orange"  target="_blank" rel="noopener noreferrer">
                            <div class="bg-theme-yellow lg:bg-theme-gray p-3 lg:p-0 rounded-full lg:rounded-none">
                    ...
                    <li>
                        <a href="https://t.me/IntiDiesel" class="flex flex-col items-center lg:bg-theme-gray rounded-lg transition duration-500 lg:hover:scale-105 p-4 lg:hover:bg-gradient-to-r lg:hover:from-theme-yellow lg:hover:to-theme-orange"  target="_blank" rel="noopener noreferrer">
                            <div class="bg-theme-yellow lg:bg-theme-gray p-3 lg:p-0 rounded-full lg:rounded-none">
                    ...
                    <li>
                        <a href="https://join.skype.com/invite/nQLQCcAsXmOd" class="flex flex-col items-center lg:bg-theme-gray rounded-lg transition duration-500 lg:hover:scale-105 p-4 lg:hover:bg-gradient-to-r lg:hover:from-theme-yellow lg:hover:to-theme-orange"  target="_blank" rel="noopener noreferrer">
                            <div class="bg-theme-yellow lg:bg-theme-gray p-3 lg:p-0 rounded-full lg:rounded-none">
                                <svg class="h-6 w-6" viewBox="0 0 37 36" fill="none" xmlns="http://www.w3.org/2000/svg">
