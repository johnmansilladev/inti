<div>
    <section>
        <div class="max-w-[60%] mx-auto my-12">
            <div class="max-w-4xl mx-auto">
                <h1 class="text-4xl font-extrabold text-theme-gray text-center uppercase">Contácte con nosotros</h1>
                <p class="text-base text-theme-gray text-center mt-2">Comuníquese con nosotros si tiene alguna pregunta sobre nuestros servicios, software disponibles, métodos de pago o medio de instalación.</p>
            </div>
            <div class="my-10">
                <form wire:submit.prevent="store" action="/about/contact" method="POST">
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            <label for="contact-phone" class="form-label">Número telefónico</label>
                            <div class="flex flex-row">
                                <div x-data="{ open: false }" class="relative w-1/5 mt-1 mr-4">
                                    <button @click="open = !open" type="button" class="relative w-full cursor-default rounded-md border border-gray-300 bg-theme-lwgray py-2 pl-3 pr-10 text-left shadow-sm focus:border-transparent focus:outline-none focus:ring-1 focus:ring-theme-yellow sm:text-sm" aria-haspopup="listbox" aria-expanded="true" aria-labelledby="listbox-label">
                                        <span class="flex items-center">
                                            ...
                                            <span class="ml-3 block">+{{ $phoneCode }}</span>
                                        </span>
                                    ...
                                    <ul x-show="open" @click.outside="open = false" style="display: none" class="absolute z-10 mt-1 max-h-56 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm" tabindex="-1" role="listbox" aria-labelledby="listbox-label" aria-activedescendant="listbox-option-3">
                                        @foreach ($countries as $country)
                                            <li wire:click="$set('phoneCode','{{ $country->phonecode }}')" class="text-gray-900 relative cursor-default select-none py-2 pl-3 pr-9" id="listbox-option-0" role="option">
                                                <div class="flex items-center">
                                                    ...
                                                    <span class="font-normal ml-3 block">+{{ $country->phonecode }}</span>
                                                </div>
                                            </li>
                                        @endforeach
                                    </ul>
                                ...
                                <div class="w-4/5">
                                    <input type="number" wire:model.defer="phone" name="phone" id="contact-phone" class="form-control @error('phone')border border-red-500 @enderror bg-theme-lwgray">
                                </div>
                            </div>    
                            @error('phone') <span class="error">*{{ $message }}</span> @enderror
                        </div>
                        <div class="col-span-6 row-span-2 sm:col-span-3">
                            <label for="contact-message" class="form-label">Mensaje</label>
                            <textarea id="contact-message" wire:model.defer="contactMessage" name="message" rows="5" class="form-control @error('contactMessage')border border-red-500 @enderror bg-theme-lwgray"></textarea> 
                            @error('contactMessage') <span class="error">*{{ $message }}</span> @enderror               
                        </div>
                        <div class="col-span-6 sm:col-span-3">
                        ...
                        <div class="col-span-6">
                            <div class="flex">
                                <div class="flex h-5 items-center">
                                    <input id="contact-politics" wire:model.defer="politics" name="politics" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-theme-yellow focus:ring-theme-yellow @error('email')border border-red-500 @enderror">
                                </div>
                                <div class="ml-3 text-sm">
                                <label for="contact-politics" class="font-medium text-gray-700">Acepto la política de privacidad de datos</label>
                                </div>
                            </div>
                            @error('politics') <span class="error">*{{ $message }}</span> @enderror
                        </div>
                    </div>
                    <div class="px-4 py-3 text-center sm:px-6 mt-8">
                        <button type="submit" class="btn btn-gray" wire:loading.attr="disabled">
    ...
    <section>
        <div class="max-w-[60%] mx-auto py-10 border-t-2 border-theme-gray">
            <div class="flex flex-row">
                <div class="w-2/5 mr-8">
                    <h1 class="text-4xl font-extrabold text-theme-gray text-center uppercase">Atención las 24 horas</h1>
                    <p class="text-base text-theme-gray text-center mt-2">Resolvemos y solucionamos tus dudas todo el día</p>
                </div>
                <ul role="list" class="w-3/5 grid grid-cols-5 gap-12">
                    <li>
                        <a href="" class="flex flex-col items-center bg-theme-gray rounded-lg transition duration-500 hover:scale-105 p-4 hover:bg-gradient-to-r hover:from-theme-yellow hover:to-theme-orange"  target="_blank" rel="noopener noreferrer">
                            ...
                            <span class="text-white text-sm font-bold mt-3">WhatsApp</span>
                        </a>
                    </li>
                    <li>
                        <a href="" class="flex flex-col items-center bg-theme-gray rounded-lg transition duration-500 hover:scale-105 p-4 hover:bg-gradient-to-r hover:from-theme-yellow hover:to-theme-orange"  target="_blank" rel="noopener noreferrer">
                            ...
                            <span class="text-white text-sm font-bold mt-3">Messenger</span>
                        </a>
                    </li>
                    <li>
                        <a href="" class="flex flex-col items-center bg-theme-gray rounded-lg transition duration-500 hover:scale-105 p-4 hover:bg-gradient-to-r hover:from-theme-yellow hover:to-theme-orange"  target="_blank" rel="noopener noreferrer">
                            ...
                            <span class="text-white text-sm font-bold mt-3">WeChat</span>
                        </a>
                    </li>
                    <li>
                        <a href="" class="flex flex-col items-center bg-theme-gray rounded-lg transition duration-500 hover:scale-105 p-4 hover:bg-gradient-to-r hover:from-theme-yellow hover:to-theme-orange"  target="_blank" rel="noopener noreferrer">
                            ...
                            <span class="text-white text-sm font-bold mt-3">Telegram</span>
                        </a>
                    </li>
                    <li>
                        <a href="" class="flex flex-col items-center bg-theme-gray rounded-lg transition duration-500 hover:scale-105 p-4 hover:bg-gradient-to-r hover:from-theme-yellow hover:to-theme-orange"  target="_blank" rel="noopener noreferrer">
                            ...
                            <span class="text-white text-sm font-bold mt-3">Skype</span>
                        </a>
                    </li>
                </ul>
            </div>
