        ...
        <div class="px-6 py-8">
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="col-span-12">
                    <h1 class="text-lg font-semibold text-theme-gray">{{ __('Datos personales') }}</h1>
                </div>
                ...
                <div class="col-span-12 md:col-span-6">
                    <x-jet-label for="firstname" class="form-label" value="{{ __('Firstname') }}" />
                    <x-jet-input id="firstname" type="text" class="form-control" wire:model.defer="state.firstname" autocomplete="firstname" />
                    <x-jet-input-error for="firstname" class="mt-2" />
                </div>

                <!-- Firstname -->
                <div class="col-span-12 md:col-span-6">
                    <x-jet-label for="lastname" class="form-label" value="{{ __('Lastname') }}" />
                    <x-jet-input id="lastname" type="text" class="form-control" wire:model.defer="state.lastname" autocomplete="lastname" />
